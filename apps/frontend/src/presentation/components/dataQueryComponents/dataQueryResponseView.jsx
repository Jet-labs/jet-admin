...
export const DataQueryResponseView = ({ dataQueryResult }) => {
  DataQueryResponseView.propTypes = {
    dataQueryResult: PropTypes.object,
  };
      ...
      <div className="w-100 h-[calc(100%-48px)]">
        {tab === 0 && (
          <PGSQLQueryResponseTableTab
            data={dataQueryResult ? dataQueryResult.result : ""}
          />
        )}
        {tab === 1 && (
