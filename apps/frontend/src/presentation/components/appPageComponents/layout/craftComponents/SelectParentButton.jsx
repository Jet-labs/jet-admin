...
export function SelectParentButton() {
  ...
  return (
    <button
      ...
      className="absolute -top-6 right-2 z-50 flex items-center gap-1 bg-primary text-primary-foreground hover:bg-primary/90 text-[9px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded shadow-sm cursor-pointer select-none pointer-events-auto transition-all border border-primary/20"
