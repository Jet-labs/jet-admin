...
export const DatabaseWidgetCustomCSSForm = ({
  tenantID,
  databaseWidgetID,
  widgetForm,
}) => {
  DatabaseWidgetCustomCSSForm.propTypes = {
    tenantID: PropTypes.number.isRequired,
    databaseWidgetID: PropTypes.number.isRequired,
    widgetForm: PropTypes.object.isRequired,
  };
  const widgetPreviewKey = `databaseWidgetPreview_${tenantID}_${databaseWidgetID}`;
  ...
  }, [tenantID, databaseWidgetID,widgetPreviewKey, open]);
