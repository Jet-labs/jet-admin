...
export const ProtectedLayout = () => {
  ...
  return (
    <div className="flex h-screen w-screen flex-col justify-start items-stretch overflow-hidden">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              <Link to={"/"} class="flex ms-2">
                ...
                <span class="ml-2 self-center text-xl font-bold whitespace-nowrap text-[#646cff">
                  {CONSTANTS.APP_NAME}
                </span>
              </Link>
            </div>
      ...
      <div class="flex w-full flex-grow flex-row justify-start items-start h-[calc(100vh-57px)]">
        <MainDrawerList />
        <div class="w-full h-[calc(100vh-57px)] overflow-y-auto bg-white">
          <Outlet />
        </div>
      </div>
    </div>
