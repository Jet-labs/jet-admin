...
export const MainDrawerList = ({ currentPageTitle }) => {
  ...
  return (
    <aside
      id="logo-sidebar"
      class=" w-80 h-[calc(100vh-57px)] overflow-y-auto transition-transform bg-white border-r border-slate-200 flex flex-col justify-start items-stretch gap-2"
      aria-label="Sidebar"
    >
      <div class="h-full p-2 overflow-y-auto bg-white">
        ...
        {tenantID ? (
          <>
            ...
            >
              <BsServer className="!w-5 !h-5 !text-slate-600 ml-0.5" />
