...
export const DatabaseDashboardWidgetListItem = ({ id, type, children }) => {
  DatabaseDashboardWidgetListItem.propTypes = {
  ...
  const [{ isDragging }, drag, dragPreview] = useDrag(
    () => ({
      type: CONSTANTS.DATABASE_DASHBOARD_ITEM_TYPES.WIDGET,
      item: () => {
