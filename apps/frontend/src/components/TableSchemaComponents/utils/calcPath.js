...
export function calcPath(r, tableWidth = 200, zoom = 1) {
  ...
  let y1 =
    r.startTable.y +
    r.startFieldId * LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_FIELD_HEIGHT +
    LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_HEADER_HEIGHT +
    LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_FIELD_HEIGHT / 2;
  let x2 = r.endTable.x;
  let y2 =
    r.endTable.y +
    r.endFieldId * LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_FIELD_HEIGHT +
    LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_HEADER_HEIGHT +
    LOCAL_CONSTANTS.TABLE_EDITOR_TABLE_FIELD_HEIGHT / 2;
