...
var ConditionNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: "w-full p-2 space-y-2 pb-0" }, /* @__PURE__ */ React2.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React2.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "Task Name"), /* @__PURE__ */ React2.createElement(
    Input,
    {
      value: title,
  ...
  )), /* @__PURE__ */ React2.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React2.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "Description"), /* @__PURE__ */ React2.createElement(
    Textarea,
    {
      value: description,
  ...
  )), /* @__PURE__ */ React2.createElement("div", { className: "rounded border border-border overflow-hidden bg-background" }, /* @__PURE__ */ React2.createElement(Tabs, { value: String(activeIdx), onValueChange: (val) => setActiveIdx(Number(val)), className: "w-full" }, /* @__PURE__ */ React2.createElement(TabsList, { className: "h-auto" }, branches.map((branch, idx) => /* @__PURE__ */ React2.createElement(
    TabsTrigger,
    {
      key: branch.id,
      value: String(idx),
    ...
    /* @__PURE__ */ React2.createElement(Plus, { className: "w-2.5 h-2.5" }),
    "Add branch"
  )), activeBranch ? /* @__PURE__ */ React2.createElement(TabsContent, { value: String(activeIdx), className: "m-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none" }, /* @__PURE__ */ React2.createElement(
    BranchEditor,
    {
      branch: activeBranch,
  ...
  )) : /* @__PURE__ */ React2.createElement("div", { className: "p-4 text-xs text-muted-foreground text-center bg-background" }, "No branches yet \u2014 click ", /* @__PURE__ */ React2.createElement("strong", null, "Add branch"), " above."))), /* @__PURE__ */ React2.createElement("div", { className: "flex items-center gap-2.5 px-3 py-2 bg-muted/30 border border-dashed border-border rounded text-xs text-muted-foreground" }, /* @__PURE__ */ React2.createElement("span", { className: "w-5 h-5 rounded-full bg-muted flex items-center justify-center text-[10px] font-bold shrink-0" }, "\u2205"), /* @__PURE__ */ React2.createElement("span", null, /* @__PURE__ */ React2.createElement("span", { className: "font-semibold text-foreground" }, "else"), " ", "\u2014 taken when none of the branches above match")), /* @__PURE__ */ React2.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React2.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "On Error"), /* @__PURE__ */ React2.createElement(Select, { value: errorHandling, onValueChange: setErrorHandling }, /* @__PURE__ */ React2.createElement(SelectTrigger, { className: "h-8 text-xs" }, /* @__PURE__ */ React2.createElement(SelectValue, null)), /* @__PURE__ */ React2.createElement(SelectContent, null, /* @__PURE__ */ React2.createElement(SelectItem, { value: "fail_workflow", className: "text-xs" }, "Fail Workflow"), /* @__PURE__ */ React2.createElement(SelectItem, { value: "continue", className: "text-xs" }, "Continue to Default Branch")))), /* @__PURE__ */ React2.createElement("div", { className: "p-3 rounded border border-primary/20 bg-primary/5 text-[10px] text-primary/80 space-y-1" }, /* @__PURE__ */ React2.createElement("div", { className: "font-semibold text-xs text-primary" }, "\u{1F4A1} Writing Conditions"), /* @__PURE__ */ React2.createElement("div", null, "Use ", /* @__PURE__ */ React2.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "{{ctx.field}}"), " in left and right inputs \u2014 e.g.", " ", /* @__PURE__ */ React2.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "{{ctx.input.severity}}"), "."), /* @__PURE__ */ React2.createElement("div", null, "The right side can also be a plain literal like", " ", /* @__PURE__ */ React2.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "High"), " or", " ", /* @__PURE__ */ React2.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "3"), "."), /* @__PURE__ */ React2.createElement("div", null, "For complex logic, use ", /* @__PURE__ */ React2.createElement("strong", null, "JS Expression"), " \u2014 raw JS where", " ", /* @__PURE__ */ React2.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "ctx.field"), " is a direct variable (no braces)."), /* @__PURE__ */ React2.createElement("div", null, "Branches are evaluated ", /* @__PURE__ */ React2.createElement("strong", null, "top \u2192 bottom"), "; first match wins.")), /* @__PURE__ */ React2.createElement(Button, { type: "button", onClick: handleSave, className: "w-full", size: "sm" }, strings?.WORKFLOW_EDITOR_CONDITION_NODE_SAVE_BUTTON || "Save Condition"));
};
var ConditionNode = memo(({ data, isConnectable }) => {
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement(
      ...
      isDisabled && /* @__PURE__ */ React2.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-orange-600 bg-orange-100 px-1.5 py-0.5 rounded border border-orange-800 shrink-0" }, /* @__PURE__ */ React2.createElement(Ban, { className: "w-2.5 h-2.5" }), "Skip")
    ),
    /* @__PURE__ */ React2.createElement("div", { className: "px-3 py-2 space-y-1" }, branches.slice(0, 6).map((branch, idx) => {
...
var DataQueryNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React3.createElement("div", { className: "w-full" }, /* @__PURE__ */ React3.createElement(JsonForms, { schema, uischema, data: formData, renderers: jetFormsRenderers, onChange: handleFormChange }), /* @__PURE__ */ React3.createElement("div", { className: "px-2" }, /* @__PURE__ */ React3.createElement("div", { className: "rounded border border-border bg-muted/30 p-3 text-[10px] text-muted-foreground space-y-2" }, /* @__PURE__ */ React3.createElement("div", { className: "font-semibold text-xs text-foreground" }, "\u{1F4D8} Query Inputs"), /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("span", { className: "font-medium text-foreground" }, "Input Format:"), /* @__PURE__ */ React3.createElement("div", { className: "ml-3 mt-0.5 font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.input.userId}}"), " \u2192 pass input value"), /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.queryResult.id}}"), " \u2192 from previous query"), /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "id_{{ctx.input.id}}"), " \u2192 string interpolation"))), /* @__PURE__ */ React3.createElement("div", null, /* @__PURE__ */ React3.createElement("span", { className: "font-medium text-foreground" }, "Access Result:"), /* @__PURE__ */ React3.createElement("div", { className: "ml-3 mt-0.5" }, "Stored in ", /* @__PURE__ */ React3.createElement("code", { className: "bg-brand-dark px-1 py-0.5 rounded border border-border font-mono" }, "ctx.{outputVariable}"), " for use in next nodes.")))), /* @__PURE__ */ React3.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ React3.createElement("div", { className: "flex items-center gap-2" }, onQueryTest && formData.dataQueryID && /* @__PURE__ */ React3.createElement(Button2, { type: "button", variant: "outline", size: "sm", onClick: handleOpenTest, className: "flex items-center gap-1.5" }, /* @__PURE__ */ React3.createElement(Play, { className: "h-3 w-3" }), "Test Query"), /* @__PURE__ */ React3.createElement(Button2, { type: "button", size: "sm", onClick: handleSave, className: "flex-1" }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_SAVE_BUTTON || "Save"))));
};
var DataQueryNode = memo2(({ id, data, isConnectable }) => {
  ...
  const StatusIndicator2 = () => {
    if (executionStatus === "running") return /* @__PURE__ */ React3.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin" }, /* @__PURE__ */ React3.createElement(RefreshCw, { className: "w-3 h-3 text-foreground" }));
    if (executionStatus === "completed") return /* @__PURE__ */ React3.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center" }, /* @__PURE__ */ React3.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React3.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
    if (executionStatus === "failed") return /* @__PURE__ */ React3.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center" }, /* @__PURE__ */ React3.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React3.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M6 18L18 6M6 6l12 12" })));
    return null;
  };
  return /* @__PURE__ */ React3.createElement("div", { className: `relative bg-brand-black border rounded min-w-[280px] max-w-[350px] transition-all duration-150 ${isDisabled ? "border-brand-border opacity-50" : getStatusStyles2()} ${!data.dataQueryID ? "!border-red-400 !bg-red-950/40" : ""}` }, /* @__PURE__ */ React3.createElement(StatusIndicator2, null), /* @__PURE__ */ React3.createElement("div", { className: "flex items-stretch" }, /* @__PURE__ */ React3.createElement(
    "div",
    {
...
var JavascriptNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React4.createElement("div", { className: "w-full" }, /* @__PURE__ */ React4.createElement(
    JsonForms2,
    {
      schema,
      uischema,
  ...
  ), /* @__PURE__ */ React4.createElement("div", { className: "px-2" }, /* @__PURE__ */ React4.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ React4.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Writing JavaScript Code"), /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("span", { className: "font-medium text-brand-text-primary" }, "Access Context:"), /* @__PURE__ */ React4.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.input.paramName"), " \u2192 workflow input"), /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.queryResult"), " \u2192 previous node output"), /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.item"), " \u2192 current loop item"))), /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("span", { className: "font-medium text-brand-text-primary" }, "Return Value:"), /* @__PURE__ */ React4.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "Use ", /* @__PURE__ */ React4.createElement("code", { className: "bg-brand-black px-1 py-0.5 rounded font-mono" }, "return yourValue;"), " to store result in output variable.")), /* @__PURE__ */ React4.createElement("div", null, /* @__PURE__ */ React4.createElement("span", { className: "font-medium text-brand-text-primary" }, "Available Globals:"), /* @__PURE__ */ React4.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ React4.createElement("code", { className: "bg-brand-black px-1 rounded font-mono text-[9px]" }, "JSON, Math, Date, Array, Object, String, Number, Boolean, parseInt, parseFloat"))), /* @__PURE__ */ React4.createElement("div", { className: "text-amber-600 bg-amber-50 border border-amber-800 rounded p-1.5 mt-2" }, /* @__PURE__ */ React4.createElement("strong", null, "\u26A0\uFE0F Note:"), " Code runs in a sandbox. No network access, filesystem, or require()."))), /* @__PURE__ */ React4.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ React4.createElement(
    Button3,
    {
      type: "button",
      size: "sm",
...
var JavascriptNode = memo3(({ id, data, isConnectable }) => {
  ...
  const StatusIndicator2 = () => {
    if (executionStatus === "running") {
      return /* @__PURE__ */ React4.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin" }, /* @__PURE__ */ React4.createElement(RefreshCw2, { className: "w-3 h-3 text-foreground" }));
    }
    if (executionStatus === "completed") {
      return /* @__PURE__ */ React4.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center" }, /* @__PURE__ */ React4.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React4.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
    }
...
var StartNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React5.createElement("div", { className: "w-full p-2 space-y-2" }, /* @__PURE__ */ React5.createElement(
    JsonForms3,
    {
      schema,
      uischema,
  ...
  ), /* @__PURE__ */ React5.createElement("div", { className: "rounded border border-border bg-muted/30 p-3 text-[10px] text-muted-foreground space-y-2" }, /* @__PURE__ */ React5.createElement("div", { className: "font-semibold text-xs text-foreground" }, "\u{1F4D8} How This Works"), /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("span", { className: "font-medium text-foreground" }, "Triggers:"), /* @__PURE__ */ React5.createElement("ul", { className: "ml-3 mt-0.5 space-y-0.5 list-disc list-inside text-muted-foreground" }, /* @__PURE__ */ React5.createElement("li", null, 'Manual: Click "Test Workflow" button'), /* @__PURE__ */ React5.createElement("li", null, "API: POST /api/v1/workflows/:id/run"), /* @__PURE__ */ React5.createElement("li", null, "Widget: Link workflow to a widget"))), /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("span", { className: "font-medium text-foreground" }, "Input Parameters:"), /* @__PURE__ */ React5.createElement("div", { className: "ml-3 mt-0.5 text-muted-foreground" }, "Define inputs in the ", /* @__PURE__ */ React5.createElement("strong", null, '"Input Parameters"'), " panel (right side). Access them using:", " ", /* @__PURE__ */ React5.createElement("code", { className: "bg-brand-dark px-1 py-0.5 rounded border border-border font-mono" }, "{{ctx.input.paramName}}"))), /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("span", { className: "font-medium text-foreground" }, "Variable Format:"), /* @__PURE__ */ React5.createElement("div", { className: "ml-3 mt-0.5 font-mono text-[9px] space-y-0.5 text-muted-foreground" }, /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.input.userId}}"), " \u2192 input parameter"), /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.queryResult}}"), " \u2192 previous node output"), /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "id_{{ctx.input.id}}"), " \u2192 string interpolation")))), /* @__PURE__ */ React5.createElement(Button4, { type: "button", size: "sm", onClick: handleSave, className: "w-full" }, "Save"));
};
var StartNode = memo4(({ id, data, isConnectable }) => {
  ...
  const StatusIndicator2 = () => {
    if (executionStatus === "running") return /* @__PURE__ */ React5.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin z-10" }, /* @__PURE__ */ React5.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React5.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" })));
    if (executionStatus === "completed") return /* @__PURE__ */ React5.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React5.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React5.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
    if (executionStatus === "failed") return /* @__PURE__ */ React5.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React5.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React5.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M6 18L18 6M6 6l12 12" })));
    return null;
  };
  return /* @__PURE__ */ React5.createElement("div", { className: `relative bg-brand-black border rounded min-w-[280px] max-w-[350px] transition-all duration-150 ${getStatusStyles2()}` }, /* @__PURE__ */ React5.createElement(StatusIndicator2, null), /* @__PURE__ */ React5.createElement("div", { className: "flex items-stretch" }, /* @__PURE__ */ React5.createElement(
    "div",
    {
      style: { borderTopLeftRadius: "0.25rem", borderBottomLeftRadius: "0.25rem" },
...
var LoopNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React6.createElement("div", { className: "w-full" }, /* @__PURE__ */ React6.createElement(
    JsonForms4,
    {
      schema,
      uischema,
  ...
  ), /* @__PURE__ */ React6.createElement("div", { className: "px-2" }, /* @__PURE__ */ React6.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ React6.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Loop Configuration"), /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("span", { className: "font-medium text-brand-text-primary" }, "Source Array Format:"), /* @__PURE__ */ React6.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.queryResult}}"), " \u2192 array from previous node"), /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.input.items}}"), " \u2192 array from input"))), /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("span", { className: "font-medium text-brand-text-primary" }, "Inside Loop Body:"), /* @__PURE__ */ React6.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.item"), " \u2192 current array element"), /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.index"), " \u2192 current iteration index (0-based)"))), /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement("span", { className: "font-medium text-brand-text-primary" }, "Handles:"), /* @__PURE__ */ React6.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ React6.createElement("strong", null, "Loop (cyan):"), " Executes for each item \u2192 ", /* @__PURE__ */ React6.createElement("strong", null, "Completed (green):"), " After all iterations")))), /* @__PURE__ */ React6.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ React6.createElement(
    Button5,
    {
      type: "button",
      size: "sm",
...
var LoopNode = memo5(({ id, data, isConnectable }) => {
  ...
  const StatusIndicator2 = () => {
    if (executionStatus === "running") return /* @__PURE__ */ React6.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin z-10" }, /* @__PURE__ */ React6.createElement(Repeat, { className: "w-3 h-3 text-foreground" }));
    if (executionStatus === "completed") return /* @__PURE__ */ React6.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React6.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React6.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
    if (executionStatus === "failed") return /* @__PURE__ */ React6.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React6.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React6.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M6 18L18 6M6 6l12 12" })));
    return null;
  };
...
var DelayNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  ), /* @__PURE__ */ React7.createElement("div", { className: "px-2" }, /* @__PURE__ */ React7.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ React7.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Delay Types"), /* @__PURE__ */ React7.createElement("div", null, /* @__PURE__ */ React7.createElement("span", { className: "font-medium text-brand-text-primary" }, "Fixed Duration:"), /* @__PURE__ */ React7.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "Set exact wait time using minutes, seconds, and milliseconds.")), /* @__PURE__ */ React7.createElement("div", null, /* @__PURE__ */ React7.createElement("span", { className: "font-medium text-brand-text-primary" }, "From Variable:"), /* @__PURE__ */ React7.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px]" }, /* @__PURE__ */ React7.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.waitTime}}"), " \u2192 value in milliseconds")), /* @__PURE__ */ React7.createElement("div", { className: "text-green-600 bg-green-50 border border-green-800 rounded p-1.5 mt-2" }, /* @__PURE__ */ React7.createElement("strong", null, "\u2713 Non-blocking:"), " Delay uses queue scheduling. Workflow resources are released during wait."))), /* @__PURE__ */ React7.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ React7.createElement(
    Button6,
    {
      type: "button",
      size: "sm",
...
import { Button as Button7, Input as Input2, TemplateAutocompleteInput as TemplateAutocompleteInput2 } from "@jet-admin/ui";
...
var OutputParameterEditor = ({ parameters, onChange, availableVariables, stateTree }) => {
  ...
  return /* @__PURE__ */ React8.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React8.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React8.createElement("label", { className: "text-xs font-medium text-brand-text-primary" }, "Output Parameters"), /* @__PURE__ */ React8.createElement(
    ...
    "Add Output"
  )), /* @__PURE__ */ React8.createElement("p", { className: "text-[10px] text-brand-text-primary" }, "Define outputs that will be returned when the workflow completes."), parameters.length === 0 ? /* @__PURE__ */ React8.createElement("div", { className: "text-xs text-brand-text-primary italic py-3 text-center border border-dashed border-brand-border rounded" }, "No output parameters defined. Workflow will complete with no output.") : /* @__PURE__ */ React8.createElement("div", { className: "space-y-2" }, parameters.map((param, index) => /* @__PURE__ */ React8.createElement(
    "div",
    {
      key: param.id,
      className: "border border-brand-border rounded p-2 bg-brand-dark"
    },
    /* @__PURE__ */ React8.createElement("div", { className: "flex items-center justify-between mb-2" }, /* @__PURE__ */ React8.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React8.createElement(
      Input2,
      {
        type: "text",
        size: "sm",
    ...
    /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("label", { className: "text-[10px] text-brand-text-primary mb-1 block" }, "Source Variable"), /* @__PURE__ */ React8.createElement(
    ...
    ), availableVariables.length > 0 && /* @__PURE__ */ React8.createElement("p", { className: "text-[9px] text-brand-text-primary mt-1" }, "Available: ", availableVariables.slice(0, 5).map((v) => `ctx.${v.variable}`).join(", "), availableVariables.length > 5 && "...")),
...
var EndNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  const upstreamStateTree = useMemo7(() => {
    const tree = { ctx: { input: {} } };
    if (workflowInputDefinitions && workflowInputDefinitions.length > 0) {
      workflowInputDefinitions.forEach((inputDef) => {
        if (inputDef.key) {
  ...
  return /* @__PURE__ */ React8.createElement("div", { className: "w-full p-2 space-y-2" }, /* @__PURE__ */ React8.createElement(
    JsonForms6,
    {
      schema,
      uischema,
  ...
  ), /* @__PURE__ */ React8.createElement("div", { className: "" }, /* @__PURE__ */ React8.createElement(
  ...
  )), /* @__PURE__ */ React8.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ React8.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Workflow Output"), /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("span", { className: "font-medium text-brand-text-primary" }, "Source Variable Format:"), /* @__PURE__ */ React8.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.queryResult}}"), " \u2192 from previous node"), /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.processedData}}"), " \u2192 from script node"))), /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("span", { className: "font-medium text-brand-text-primary" }, "Completion Status:"), /* @__PURE__ */ React8.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ React8.createElement("strong", null, "Success:"), " Normal completion \u2022 ", /* @__PURE__ */ React8.createElement("strong", null, "Failure:"), " Ended with error \u2022 ", /* @__PURE__ */ React8.createElement("strong", null, "Cancelled:"), " Manual stop")), /* @__PURE__ */ React8.createElement("div", null, /* @__PURE__ */ React8.createElement("span", { className: "font-medium text-brand-text-primary" }, "Multiple End Nodes:"), /* @__PURE__ */ React8.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "You can have multiple End nodes for different outcomes (e.g., success/failure branches)."))), /* @__PURE__ */ React8.createElement(
    Button7,
    {
      type: "button",
      size: "sm",
...
var EndNode = memo7(({ id, data, isConnectable }) => {
  ...
  const ExecutionIndicator = () => {
    if (executionStatus === "running") {
      return /* @__PURE__ */ React8.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin z-10" }, /* @__PURE__ */ React8.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React8.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" })));
    }
    if (executionStatus === "completed") {
      return /* @__PURE__ */ React8.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React8.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React8.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
    }
    if (executionStatus === "failed") {
      return /* @__PURE__ */ React8.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React8.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React8.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M6 18L18 6M6 6l12 12" })));
    }
...
var StatusIndicator = ({ executionStatus }) => {
  if (executionStatus === "running") {
    return /* @__PURE__ */ React9.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center animate-spin z-10" }, /* @__PURE__ */ React9.createElement(RefreshCw3, { className: "w-3 h-3 text-foreground" }));
  }
  if (executionStatus === "completed") {
    return /* @__PURE__ */ React9.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React9.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React9.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" })));
  }
  if (executionStatus === "failed") {
    return /* @__PURE__ */ React9.createElement("div", { className: "absolute -top-2 -right-2 w-5 h-5 bg-primary rounded-full flex items-center justify-center z-10" }, /* @__PURE__ */ React9.createElement("svg", { className: "w-3 h-3 text-foreground", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, /* @__PURE__ */ React9.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M6 18L18 6M6 6l12 12" })));
  }
...
var DataCollectionNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ React10.createElement("div", { className: "w-full p-2 space-y-2" }, /* @__PURE__ */ React10.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Modal title"), /* @__PURE__ */ React10.createElement(
    Input3,
    {
      value: title,
      onChange: (e) => setTitle(e.target.value),
  ...
  )), /* @__PURE__ */ React10.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Instructions"), /* @__PURE__ */ React10.createElement(
    Textarea2,
    {
      value: description,
      onChange: (e) => setDescription(e.target.value),
  ...
  )), /* @__PURE__ */ React10.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Collection method"), /* @__PURE__ */ React10.createElement(Select2, { value: collectionType, onValueChange: setCollectionType }, /* @__PURE__ */ React10.createElement(SelectTrigger2, { className: "h-8 text-xs" }, /* @__PURE__ */ React10.createElement(SelectValue2, null)), /* @__PURE__ */ React10.createElement(SelectContent2, null, COLLECTION_TYPES.map((t) => /* @__PURE__ */ React10.createElement(SelectItem2, { key: t.value, value: t.value, disabled: t.disabled, className: "text-xs" }, t.label))))), collectionType === "form" && /* @__PURE__ */ React10.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React10.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Form fields"), /* @__PURE__ */ React10.createElement(
    Button8,
    {
      type: "button",
      variant: "ghost",
  ...
  ))), /* @__PURE__ */ React10.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Output variable"), /* @__PURE__ */ React10.createElement(
    Input3,
    {
  ...
  ), /* @__PURE__ */ React10.createElement("p", { className: "text-[10px] text-muted-foreground" }, "Access via", " ", /* @__PURE__ */ React10.createElement("code", { className: "bg-muted px-1 rounded font-mono" }, `{{ctx.${outputVariable || "collectedData"}}}`))), /* @__PURE__ */ React10.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React10.createElement(Label2, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Expiry (minutes) \u2014 0 = never"), /* @__PURE__ */ React10.createElement(
    Input3,
    {
      type: "number",
      value: expiryMinutes,
  ...
  )), /* @__PURE__ */ React10.createElement("div", { className: "rounded border border-primary/20 bg-primary/5 p-3 text-[10px] text-primary/80 space-y-1" }, /* @__PURE__ */ React10.createElement("div", { className: "font-semibold text-xs text-primary" }, "Suspend & resume"), /* @__PURE__ */ React10.createElement("div", null, "When this node runs, the workflow ", /* @__PURE__ */ React10.createElement("strong", null, "pauses"), " and a form modal appears in the execution panel. The DAG only advances once the user clicks ", /* @__PURE__ */ React10.createElement("em", null, "Submit & continue"), "."), /* @__PURE__ */ React10.createElement("div", null, "Field values land in", " ", /* @__PURE__ */ React10.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, `ctx.${outputVariable || "collectedData"}`), " ", "as a plain object.")), /* @__PURE__ */ React10.createElement(Button8, { type: "button", size: "sm", onClick: handleSave, className: "w-full" }, "Save"));
};
var DataCollectionNode = memo8(({ id, data, isConnectable }) => {
  ...
  return /* @__PURE__ */ React10.createElement("div", { className: `
    ...
    isSuspended ? /* @__PURE__ */ React10.createElement(ArrowRightToLine, { className: "w-5 h-5 text-amber-600" }) : /* @__PURE__ */ React10.createElement(FileText, { className: `w-5 h-5 ${isDisabled ? "text-brand-text-primary" : executionStatus === "running" ? "text-blue-600" : executionStatus === "completed" ? "text-green-600" : executionStatus === "failed" ? "text-red-600" : "text-violet-500"}` })
              ...
              ${isDisabled ? "text-brand-text-primary line-through" : "text-brand-text-primary"}` }, data?.title || "Data collection"), isSuspended && /* @__PURE__ */ React10.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-amber-700 bg-amber-100 px-1.5 py-0.5 rounded border border-amber-800 whitespace-nowrap" }, "\u23F8 Waiting"), isDisabled && !isSuspended && /* @__PURE__ */ React10.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-orange-600 bg-orange-100 px-1.5 py-0.5 rounded border border-orange-800" }, /* @__PURE__ */ React10.createElement(Ban6, { className: "w-2.5 h-2.5" }), "Skip")), /* @__PURE__ */ React10.createElement("div", { className: `text-[10px] mt-0.5 ${isDisabled ? "text-brand-text-primary" : "text-brand-text-primary"}` }, fieldCount > 0 ? `${fieldCount} field${fieldCount !== 1 ? "s" : ""} \xB7 saves to ctx.${data?.outputVariable || "collectedData"}` : "No fields defined yet")), /* @__PURE__ */ React10.createElement("div", { className: "flex flex-col items-center justify-center px-2 border-l border-brand-border" }, /* @__PURE__ */ React10.createElement(
    "div",
    {
