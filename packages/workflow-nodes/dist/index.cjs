...
var WorkflowNodesProvider = ({ children, dataQueries, strings = {} }) => {
  return /* @__PURE__ */ import_react.default.createElement(WorkflowNodesContext.Provider, { value: { dataQueries, strings } }, children);
};
...
var ConditionNode = (0, import_react4.memo)(({ data, isConnectable }) => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "bg-white border-2 border-orange-200 rounded shadow-md min-w-[150px] hover:border-orange-400 transition-colors" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "bg-orange-50 px-3 py-1 border-b border-orange-100 rounded-t text-xs font-bold text-orange-700" }, strings.WORKFLOW_EDITOR_CONDITION_NODE_LABEL), /* @__PURE__ */ import_react4.default.createElement("div", { className: "p-3 text-sm" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ import_react4.default.createElement(TbLogicAnd, { className: "text-orange-500 text-lg" }), /* @__PURE__ */ import_react4.default.createElement("span", { className: "font-bold text-slate-700" }, data.label || "Condition")), /* @__PURE__ */ import_react4.default.createElement("div", { className: "text-xs text-gray-500 font-mono bg-gray-50 p-2 rounded break-all border border-gray-100" }, data.condition || "true")), /* @__PURE__ */ import_react4.default.createElement(
  ...
  ), /* @__PURE__ */ import_react4.default.createElement("div", { className: "absolute -bottom-6 left-1/4 transform -translate-x-1/2 flex flex-col items-center" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "text-[10px] text-green-600 font-bold mb-1" }, "TRUE"), /* @__PURE__ */ import_react4.default.createElement(
    import_reactflow.Handle,
    {
      type: "source",
  ...
  )), /* @__PURE__ */ import_react4.default.createElement("div", { className: "absolute -bottom-6 right-1/4 transform translate-x-1/2 flex flex-col items-center" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "text-[10px] text-red-600 font-bold mb-1" }, "FALSE"), /* @__PURE__ */ import_react4.default.createElement(
    import_reactflow.Handle,
    {
      type: "source",
      position: import_reactflow.Position.Bottom,
...
var FormikContext = /* @__PURE__ */ (0, import_react5.createContext)(void 0);
FormikContext.displayName = "FormikContext";
var FormikProvider = FormikContext.Provider;
var FormikConsumer = FormikContext.Consumer;
function useFormikContext() {
  var formik = (0, import_react5.useContext)(FormikContext);
...
var isEmptyChildren = function isEmptyChildren2(children) {
  return import_react5.Children.count(children) === 0;
};
...
function useFormik(_ref) {
  ...
  var initialValues = (0, import_react5.useRef)(props.initialValues);
  var initialErrors = (0, import_react5.useRef)(props.initialErrors || emptyErrors);
  var initialTouched = (0, import_react5.useRef)(props.initialTouched || emptyTouched);
  var initialStatus = (0, import_react5.useRef)(props.initialStatus);
  var isMounted = (0, import_react5.useRef)(false);
  var fieldRegistry = (0, import_react5.useRef)({});
  if (true) {
  ...
  var _React$useState = (0, import_react5.useState)(0), setIteration = _React$useState[1];
  ...
  var runValidateHandler = (0, import_react5.useCallback)(function(values, field) {
  ...
  var runValidationSchema = (0, import_react5.useCallback)(function(values, field) {
  ...
  var runSingleFieldLevelValidation = (0, import_react5.useCallback)(function(field, value) {
    return new Promise(function(resolve) {
      return resolve(fieldRegistry.current[field].validate(value));
    });
  }, []);
  var runFieldLevelValidations = (0, import_react5.useCallback)(function(values) {
  ...
  var runAllValidations = (0, import_react5.useCallback)(function(values) {
  ...
  var resetForm = (0, import_react5.useCallback)(function(nextState) {
  ...
  var registerField = (0, import_react5.useCallback)(function(name, _ref3) {
    var validate = _ref3.validate;
    fieldRegistry.current[name] = {
      validate
    };
  }, []);
  var unregisterField = (0, import_react5.useCallback)(function(name) {
  ...
  var setErrors = (0, import_react5.useCallback)(function(errors) {
    dispatch({
      type: "SET_ERRORS",
      payload: errors
    });
  ...
  var setFieldError = (0, import_react5.useCallback)(function(field, value) {
    dispatch({
      type: "SET_FIELD_ERROR",
      payload: {
        field,
  ...
  var executeChange = (0, import_react5.useCallback)(function(eventOrTextValue, maybePath) {
    var field = maybePath;
  ...
  var executeBlur = (0, import_react5.useCallback)(function(e, path) {
    if (e.persist) {
      e.persist();
    }
  ...
  var setFormikState = (0, import_react5.useCallback)(function(stateOrCb) {
  ...
  var setStatus = (0, import_react5.useCallback)(function(status) {
    dispatch({
      type: "SET_STATUS",
      payload: status
    });
  }, []);
  var setSubmitting = (0, import_react5.useCallback)(function(isSubmitting) {
    dispatch({
  ...
  var getFieldMeta = (0, import_react5.useCallback)(function(name) {
    return {
  ...
  var getFieldHelpers = (0, import_react5.useCallback)(function(name) {
    return {
  ...
  var getFieldProps = (0, import_react5.useCallback)(function(nameOrOptions) {
  ...
  var dirty = (0, import_react5.useMemo)(function() {
    return !(0, import_react_fast_compare.default)(initialValues.current, state.values);
  }, [initialValues.current, state.values]);
  var isValid = (0, import_react5.useMemo)(function() {
...
function useEventCallback(fn) {
  var ref = (0, import_react5.useRef)(fn);
...
var Form = /* @__PURE__ */ (0, import_react5.forwardRef)(function(props, ref) {
  var action = props.action, rest = _objectWithoutPropertiesLoose2(props, ["action"]);
  var _action = action != null ? action : "#";
  var _useFormikContext = useFormikContext(), handleReset = _useFormikContext.handleReset, handleSubmit = _useFormikContext.handleSubmit;
  return (0, import_react5.createElement)("form", _extends2({
...
var FieldArrayInner = /* @__PURE__ */ (function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return component ? (0, import_react5.createElement)(component, props) : render2 ? render2(props) : children ? typeof children === "function" ? children(props) : !isEmptyChildren(children) ? import_react5.Children.only(children) : null : null;
  };
...
var DataQueryNodeConfigurator = ({ data, onChange }) => {
  ...
  const _handleUpdateDatasetQueryArgs = (0, import_react7.useCallback)((arg, value) => {
    configurationForm.setFieldValue(`args.${arg}`, value);
  }, [configurationForm]);
  const selectedQuery = (0, import_react8.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "w-full h-full" }, /* @__PURE__ */ import_react6.default.createElement(
    "form",
    {
      onSubmit: configurationForm.handleSubmit,
      className: "space-y-3"
    },
    /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex flex-col justify-start items-stretch h-full" }, /* @__PURE__ */ import_react6.default.createElement("label", { className: "block mb-1 text-xs font-medium text-slate-500" }, strings.WORKFLOW_EDITOR_DATA_QUERY_TITLE_LABEL), /* @__PURE__ */ import_react6.default.createElement(
      "input",
      {
        type: "text",
        name: "title",
    ...
    /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex flex-col justify-start items-stretch h-full" }, /* @__PURE__ */ import_react6.default.createElement("label", { className: "block mb-1 text-xs font-medium text-slate-500" }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_LABEL), /* @__PURE__ */ import_react6.default.createElement(
      "select",
      {
        name: "dataQueryID",
        id: "dataQueryID",
      ...
      /* @__PURE__ */ import_react6.default.createElement("option", { value: "", disabled: true, selected: true }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_SELECT_LABEL),
      dataQueries?.map((query) => /* @__PURE__ */ import_react6.default.createElement("option", { key: query.dataQueryID, value: query.dataQueryID }, query.dataQueryTitle))
    )),
    selectedQuery?.dataQueryOptions?.args?.length > 0 && /* @__PURE__ */ import_react6.default.createElement("div", null, /* @__PURE__ */ import_react6.default.createElement("label", { className: "block mb-2 text-xs font-normal text-slate-500" }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_ARGUMENTS_LABEL), /* @__PURE__ */ import_react6.default.createElement("div", { className: "space-y-2" }, selectedQuery.dataQueryOptions.args.map((arg, argIndex) => {
      const argName = arg.key;
      return /* @__PURE__ */ import_react6.default.createElement("div", { key: `arg-${argIndex}`, className: "flex flex-row justify-between items-center" }, /* @__PURE__ */ import_react6.default.createElement(
        "input",
        {
          type: "text",
          id: `arg-${argName}`,
        ...
        /* @__PURE__ */ import_react6.default.createElement(VscJson, { className: "w-4 h-4 " })
      ));
    }))),
    /* @__PURE__ */ import_react6.default.createElement(
      "button",
...
var DataQueryNode = (0, import_react6.memo)(({ data, isConnectable }) => {
  const { dataQueries, strings } = useWorkflowNodes();
  const [selectedQueryTitle, setSelectedQueryTitle] = (0, import_react6.useState)("Select a Query");
  (0, import_react6.useEffect)(() => {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "bg-white border rounded shadow-md min-w-[250px] max-w-[300px] hover:border-blue-400 transition-colors" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "bg-blue-50 px-2 py-1 border-b rounded-t font-semibold flex justify-between items-center" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "flex flex-col justify-start items-start w-full" }, /* @__PURE__ */ import_react6.default.createElement("span", { className: " font-normal text-slate-500 truncate max-w-[100px] text-xs" }, data?.title ? data.title : "Untitled node"), /* @__PURE__ */ import_react6.default.createElement("span", { className: " font-normal text-slate-500 text-[10px]" }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_LABEL)), /* @__PURE__ */ import_react6.default.createElement("button", { type: "button", className: "text-red-500 text-xs bg-transparent p-1 outline-none rounded border-none hover:bg-red-100 !hover:border-red-200 ml-2" }, /* @__PURE__ */ import_react6.default.createElement(MdOutlineDeleteOutline, { className: "w-4 h-4" }))), /* @__PURE__ */ import_react6.default.createElement("div", { className: "p-3 text-sm" }, /* @__PURE__ */ import_react6.default.createElement("div", { className: "font-medium text-slate-700 flex items-center gap-2" }, /* @__PURE__ */ import_react6.default.createElement(SiQuantconnect, { className: "text-blue-500 text-lg" }), selectedQueryTitle), data.args && Object.keys(data.args).length > 0 && /* @__PURE__ */ import_react6.default.createElement("div", { className: "mt-2 text-[10px] text-slate-500 bg-slate-50 p-1.5 rounded border border-slate-100" }, Object.keys(data.args).length, " argument(s) configured")), /* @__PURE__ */ import_react6.default.createElement(
...
var JavascriptNode = (0, import_react9.memo)(({ data, isConnectable }) => {
  const { strings } = useWorkflowNodes();
  return /* @__PURE__ */ import_react9.default.createElement("div", { className: "bg-white border rounded shadow-md min-w-[200px] hover:border-yellow-400 transition-colors" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "bg-yellow-50 px-3 py-1 border-b rounded-t text-xs font-bold text-yellow-700 flex justify-between items-center" }, /* @__PURE__ */ import_react9.default.createElement("span", null, strings.WORKFLOW_EDITOR_JAVASCRIPT_NODE_LABEL)), /* @__PURE__ */ import_react9.default.createElement("div", { className: "p-3" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "flex items-center gap-2 mb-1" }, /* @__PURE__ */ import_react9.default.createElement(FaJs, { className: "text-yellow-500 text-lg" }), /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-bold text-sm text-slate-700 break-all" }, data.label || "Script")), /* @__PURE__ */ import_react9.default.createElement("div", { className: "text-[10px] text-slate-400 font-mono bg-slate-50 p-1.5 rounded truncate" }, data.code ? `${data.code.substring(0, 30)}...` : "// No code")), /* @__PURE__ */ import_react9.default.createElement(
