...
var ConditionNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  const ctxStateTree = (0, import_react2.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: "w-full p-2 space-y-2 pb-0" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react2.default.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "Task Name"), /* @__PURE__ */ import_react2.default.createElement(
    import_ui.Input,
    {
      value: title,
  ...
  )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react2.default.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "Description"), /* @__PURE__ */ import_react2.default.createElement(
    import_ui.Textarea,
    {
      value: description,
  ...
  )), /* @__PURE__ */ import_react2.default.createElement("div", { className: "rounded border border-border overflow-hidden bg-background" }, /* @__PURE__ */ import_react2.default.createElement(import_ui.Tabs, { value: String(activeIdx), onValueChange: (val) => setActiveIdx(Number(val)), className: "w-full" }, /* @__PURE__ */ import_react2.default.createElement(import_ui.TabsList, { className: "h-auto" }, branches.map((branch, idx) => /* @__PURE__ */ import_react2.default.createElement(
  ...
  )) : /* @__PURE__ */ import_react2.default.createElement("div", { className: "p-4 text-xs text-muted-foreground text-center bg-background" }, "No branches yet \u2014 click ", /* @__PURE__ */ import_react2.default.createElement("strong", null, "Add branch"), " above."))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "flex items-center gap-2.5 px-3 py-2 bg-muted/30 border border-dashed border-border rounded text-xs text-muted-foreground" }, /* @__PURE__ */ import_react2.default.createElement("span", { className: "w-5 h-5 rounded-full bg-muted flex items-center justify-center text-[10px] font-bold shrink-0" }, "\u2205"), /* @__PURE__ */ import_react2.default.createElement("span", null, /* @__PURE__ */ import_react2.default.createElement("span", { className: "font-semibold text-foreground" }, "else"), " ", "\u2014 taken when none of the branches above match")), /* @__PURE__ */ import_react2.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react2.default.createElement("p", { className: "font-mono text-[10px] font-semibold uppercase tracking-widest text-muted-foreground" }, "On Error"), /* @__PURE__ */ import_react2.default.createElement(import_ui.Select, { value: errorHandling, onValueChange: setErrorHandling }, /* @__PURE__ */ import_react2.default.createElement(import_ui.SelectTrigger, { className: "h-8 text-xs" }, /* @__PURE__ */ import_react2.default.createElement(import_ui.SelectValue, null)), /* @__PURE__ */ import_react2.default.createElement(import_ui.SelectContent, null, /* @__PURE__ */ import_react2.default.createElement(import_ui.SelectItem, { value: "fail_workflow", className: "text-xs" }, "Fail Workflow"), /* @__PURE__ */ import_react2.default.createElement(import_ui.SelectItem, { value: "continue", className: "text-xs" }, "Continue to Default Branch")))), /* @__PURE__ */ import_react2.default.createElement("div", { className: "p-3 rounded border border-primary/20 bg-primary/5 text-[10px] text-primary/80 space-y-1" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "font-semibold text-xs text-primary" }, "\u{1F4A1} Writing Conditions"), /* @__PURE__ */ import_react2.default.createElement("div", null, "Use ", /* @__PURE__ */ import_react2.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "{{ctx.field}}"), " in left and right inputs \u2014 e.g.", " ", /* @__PURE__ */ import_react2.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "{{ctx.input.severity}}"), "."), /* @__PURE__ */ import_react2.default.createElement("div", null, "The right side can also be a plain literal like", " ", /* @__PURE__ */ import_react2.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "High"), " or", " ", /* @__PURE__ */ import_react2.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "3"), "."), /* @__PURE__ */ import_react2.default.createElement("div", null, "For complex logic, use ", /* @__PURE__ */ import_react2.default.createElement("strong", null, "JS Expression"), " \u2014 raw JS where", " ", /* @__PURE__ */ import_react2.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, "ctx.field"), " is a direct variable (no braces)."), /* @__PURE__ */ import_react2.default.createElement("div", null, "Branches are evaluated ", /* @__PURE__ */ import_react2.default.createElement("strong", null, "top \u2192 bottom"), "; first match wins.")), /* @__PURE__ */ import_react2.default.createElement(import_ui.Button, { type: "button", onClick: handleSave, className: "w-full", size: "sm" }, strings?.WORKFLOW_EDITOR_CONDITION_NODE_SAVE_BUTTON || "Save Condition"));
};
var ConditionNode = (0, import_react2.memo)(({ data, isConnectable }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(
    ...
    /* @__PURE__ */ import_react2.default.createElement(
      ...
      isDisabled && /* @__PURE__ */ import_react2.default.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-orange-600 bg-orange-100 px-1.5 py-0.5 rounded border border-orange-800 shrink-0" }, /* @__PURE__ */ import_react2.default.createElement(import_lucide_react.Ban, { className: "w-2.5 h-2.5" }), "Skip")
    ),
    /* @__PURE__ */ import_react2.default.createElement("div", { className: "px-3 py-2 space-y-1" }, branches.slice(0, 6).map((branch, idx) => {
...
var DataQueryNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "w-full" }, /* @__PURE__ */ import_react3.default.createElement(import_react4.JsonForms, { schema, uischema, data: formData, renderers: import_json_forms_renderers.jetFormsRenderers, onChange: handleFormChange }), /* @__PURE__ */ import_react3.default.createElement("div", { className: "px-2" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "rounded border border-border bg-muted/30 p-3 text-[10px] text-muted-foreground space-y-2" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "font-semibold text-xs text-foreground" }, "\u{1F4D8} Query Inputs"), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("span", { className: "font-medium text-foreground" }, "Input Format:"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "ml-3 mt-0.5 font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.input.userId}}"), " \u2192 pass input value"), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.queryResult.id}}"), " \u2192 from previous query"), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "id_{{ctx.input.id}}"), " \u2192 string interpolation"))), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("span", { className: "font-medium text-foreground" }, "Access Result:"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "ml-3 mt-0.5" }, "Stored in ", /* @__PURE__ */ import_react3.default.createElement("code", { className: "bg-brand-dark px-1 py-0.5 rounded border border-border font-mono" }, "ctx.{outputVariable}"), " for use in next nodes.")))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center gap-2" }, onQueryTest && formData.dataQueryID && /* @__PURE__ */ import_react3.default.createElement(import_ui2.Button, { type: "button", variant: "outline", size: "sm", onClick: handleOpenTest, className: "flex items-center gap-1.5" }, /* @__PURE__ */ import_react3.default.createElement(import_lucide_react2.Play, { className: "h-3 w-3" }), "Test Query"), /* @__PURE__ */ import_react3.default.createElement(import_ui2.Button, { type: "button", size: "sm", onClick: handleSave, className: "flex-1" }, strings.WORKFLOW_EDITOR_DATA_QUERY_NODE_SAVE_BUTTON || "Save"))));
};
...
var JavascriptNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  ), /* @__PURE__ */ import_react5.default.createElement("div", { className: "px-2" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Writing JavaScript Code"), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Access Context:"), /* @__PURE__ */ import_react5.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.input.paramName"), " \u2192 workflow input"), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.queryResult"), " \u2192 previous node output"), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.item"), " \u2192 current loop item"))), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Return Value:"), /* @__PURE__ */ import_react5.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "Use ", /* @__PURE__ */ import_react5.default.createElement("code", { className: "bg-brand-black px-1 py-0.5 rounded font-mono" }, "return yourValue;"), " to store result in output variable.")), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Available Globals:"), /* @__PURE__ */ import_react5.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ import_react5.default.createElement("code", { className: "bg-brand-black px-1 rounded font-mono text-[9px]" }, "JSON, Math, Date, Array, Object, String, Number, Boolean, parseInt, parseFloat"))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "text-amber-600 bg-amber-50 border border-amber-800 rounded p-1.5 mt-2" }, /* @__PURE__ */ import_react5.default.createElement("strong", null, "\u26A0\uFE0F Note:"), " Code runs in a sandbox. No network access, filesystem, or require()."))), /* @__PURE__ */ import_react5.default.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ import_react5.default.createElement(
    import_ui3.Button,
    {
      type: "button",
      size: "sm",
...
var StartNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  ), /* @__PURE__ */ import_react7.default.createElement("div", { className: "rounded border border-border bg-muted/30 p-3 text-[10px] text-muted-foreground space-y-2" }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "font-semibold text-xs text-foreground" }, "\u{1F4D8} How This Works"), /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("span", { className: "font-medium text-foreground" }, "Triggers:"), /* @__PURE__ */ import_react7.default.createElement("ul", { className: "ml-3 mt-0.5 space-y-0.5 list-disc list-inside text-muted-foreground" }, /* @__PURE__ */ import_react7.default.createElement("li", null, 'Manual: Click "Test Workflow" button'), /* @__PURE__ */ import_react7.default.createElement("li", null, "API: POST /api/v1/workflows/:id/run"), /* @__PURE__ */ import_react7.default.createElement("li", null, "Widget: Link workflow to a widget"))), /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("span", { className: "font-medium text-foreground" }, "Input Parameters:"), /* @__PURE__ */ import_react7.default.createElement("div", { className: "ml-3 mt-0.5 text-muted-foreground" }, "Define inputs in the ", /* @__PURE__ */ import_react7.default.createElement("strong", null, '"Input Parameters"'), " panel (right side). Access them using:", " ", /* @__PURE__ */ import_react7.default.createElement("code", { className: "bg-brand-dark px-1 py-0.5 rounded border border-border font-mono" }, "{{ctx.input.paramName}}"))), /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("span", { className: "font-medium text-foreground" }, "Variable Format:"), /* @__PURE__ */ import_react7.default.createElement("div", { className: "ml-3 mt-0.5 font-mono text-[9px] space-y-0.5 text-muted-foreground" }, /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.input.userId}}"), " \u2192 input parameter"), /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "{{ctx.queryResult}}"), " \u2192 previous node output"), /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border" }, "id_{{ctx.input.id}}"), " \u2192 string interpolation")))), /* @__PURE__ */ import_react7.default.createElement(import_ui4.Button, { type: "button", size: "sm", onClick: handleSave, className: "w-full" }, "Save"));
};
...
var LoopNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  ), /* @__PURE__ */ import_react9.default.createElement("div", { className: "px-2" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ import_react9.default.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Loop Configuration"), /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Source Array Format:"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.queryResult}}"), " \u2192 array from previous node"), /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.input.items}}"), " \u2192 array from input"))), /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Inside Loop Body:"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.item"), " \u2192 current array element"), /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "ctx.index"), " \u2192 current iteration index (0-based)"))), /* @__PURE__ */ import_react9.default.createElement("div", null, /* @__PURE__ */ import_react9.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Handles:"), /* @__PURE__ */ import_react9.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ import_react9.default.createElement("strong", null, "Loop (cyan):"), " Executes for each item \u2192 ", /* @__PURE__ */ import_react9.default.createElement("strong", null, "Completed (green):"), " After all iterations")))), /* @__PURE__ */ import_react9.default.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ import_react9.default.createElement(
    import_ui5.Button,
    {
      type: "button",
      size: "sm",
...
var DelayNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  ), /* @__PURE__ */ import_react11.default.createElement("div", { className: "px-2" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Delay Types"), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Fixed Duration:"), /* @__PURE__ */ import_react11.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "Set exact wait time using minutes, seconds, and milliseconds.")), /* @__PURE__ */ import_react11.default.createElement("div", null, /* @__PURE__ */ import_react11.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "From Variable:"), /* @__PURE__ */ import_react11.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px]" }, /* @__PURE__ */ import_react11.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.waitTime}}"), " \u2192 value in milliseconds")), /* @__PURE__ */ import_react11.default.createElement("div", { className: "text-green-600 bg-green-50 border border-green-800 rounded p-1.5 mt-2" }, /* @__PURE__ */ import_react11.default.createElement("strong", null, "\u2713 Non-blocking:"), " Delay uses queue scheduling. Workflow resources are released during wait."))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "px-2 mt-2" }, /* @__PURE__ */ import_react11.default.createElement(
    import_ui6.Button,
    {
      type: "button",
      size: "sm",
...
var EndNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  )), /* @__PURE__ */ import_react13.default.createElement("div", { className: "p-2.5 bg-brand-dark border border-brand-border rounded text-[10px] text-brand-text-primary space-y-2" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "font-semibold text-brand-text-primary text-xs" }, "\u{1F4D8} Workflow Output"), /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Source Variable Format:"), /* @__PURE__ */ import_react13.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary font-mono text-[9px] space-y-0.5" }, /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.queryResult}}"), " \u2192 from previous node"), /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("code", { className: "bg-brand-black px-1 rounded" }, "{{ctx.processedData}}"), " \u2192 from script node"))), /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Completion Status:"), /* @__PURE__ */ import_react13.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, /* @__PURE__ */ import_react13.default.createElement("strong", null, "Success:"), " Normal completion \u2022 ", /* @__PURE__ */ import_react13.default.createElement("strong", null, "Failure:"), " Ended with error \u2022 ", /* @__PURE__ */ import_react13.default.createElement("strong", null, "Cancelled:"), " Manual stop")), /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("span", { className: "font-medium text-brand-text-primary" }, "Multiple End Nodes:"), /* @__PURE__ */ import_react13.default.createElement("div", { className: "ml-3 mt-0.5 text-brand-text-primary" }, "You can have multiple End nodes for different outcomes (e.g., success/failure branches)."))), /* @__PURE__ */ import_react13.default.createElement(
    import_ui7.Button,
    {
      type: "button",
      size: "sm",
...
var DataCollectionNodeConfigurator = ({ data, onChange, nodeId }) => {
  ...
  return /* @__PURE__ */ import_react16.default.createElement("div", { className: "w-full p-2 space-y-2" }, /* @__PURE__ */ import_react16.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react16.default.createElement(import_ui8.Label, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Modal title"), /* @__PURE__ */ import_react16.default.createElement(
    import_ui8.Input,
    {
      value: title,
      onChange: (e) => setTitle(e.target.value),
  ...
  )), /* @__PURE__ */ import_react16.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react16.default.createElement(import_ui8.Label, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Instructions"), /* @__PURE__ */ import_react16.default.createElement(
    import_ui8.Textarea,
    {
      value: description,
      onChange: (e) => setDescription(e.target.value),
  ...
  ))), /* @__PURE__ */ import_react16.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react16.default.createElement(import_ui8.Label, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Output variable"), /* @__PURE__ */ import_react16.default.createElement(
    import_ui8.Input,
    {
  ...
  ), /* @__PURE__ */ import_react16.default.createElement("p", { className: "text-[10px] text-muted-foreground" }, "Access via", " ", /* @__PURE__ */ import_react16.default.createElement("code", { className: "bg-muted px-1 rounded font-mono" }, `{{ctx.${outputVariable || "collectedData"}}}`))), /* @__PURE__ */ import_react16.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react16.default.createElement(import_ui8.Label, { className: "text-[10px] font-bold uppercase tracking-wider text-muted-foreground" }, "Expiry (minutes) \u2014 0 = never"), /* @__PURE__ */ import_react16.default.createElement(
    import_ui8.Input,
    {
      type: "number",
      value: expiryMinutes,
  ...
  )), /* @__PURE__ */ import_react16.default.createElement("div", { className: "rounded border border-primary/20 bg-primary/5 p-3 text-[10px] text-primary/80 space-y-1" }, /* @__PURE__ */ import_react16.default.createElement("div", { className: "font-semibold text-xs text-primary" }, "Suspend & resume"), /* @__PURE__ */ import_react16.default.createElement("div", null, "When this node runs, the workflow ", /* @__PURE__ */ import_react16.default.createElement("strong", null, "pauses"), " and a form modal appears in the execution panel. The DAG only advances once the user clicks ", /* @__PURE__ */ import_react16.default.createElement("em", null, "Submit & continue"), "."), /* @__PURE__ */ import_react16.default.createElement("div", null, "Field values land in", " ", /* @__PURE__ */ import_react16.default.createElement("code", { className: "bg-brand-dark px-1 rounded border border-border font-mono" }, `ctx.${outputVariable || "collectedData"}`), " ", "as a plain object.")), /* @__PURE__ */ import_react16.default.createElement(import_ui8.Button, { type: "button", size: "sm", onClick: handleSave, className: "w-full" }, "Save"));
};
var DataCollectionNode = (0, import_react16.memo)(({ id, data, isConnectable }) => {
  ...
  return /* @__PURE__ */ import_react16.default.createElement("div", { className: `
    ...
    isSuspended ? /* @__PURE__ */ import_react16.default.createElement(import_lucide_react9.ArrowRightToLine, { className: "w-5 h-5 text-amber-600" }) : /* @__PURE__ */ import_react16.default.createElement(import_lucide_react9.FileText, { className: `w-5 h-5 ${isDisabled ? "text-brand-text-primary" : executionStatus === "running" ? "text-blue-600" : executionStatus === "completed" ? "text-green-600" : executionStatus === "failed" ? "text-red-600" : "text-violet-500"}` })
              ...
              ${isDisabled ? "text-brand-text-primary line-through" : "text-brand-text-primary"}` }, data?.title || "Data collection"), isSuspended && /* @__PURE__ */ import_react16.default.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-amber-700 bg-amber-100 px-1.5 py-0.5 rounded border border-amber-800 whitespace-nowrap" }, "\u23F8 Waiting"), isDisabled && !isSuspended && /* @__PURE__ */ import_react16.default.createElement("span", { className: "inline-flex items-center gap-1 text-[9px] font-medium text-orange-600 bg-orange-100 px-1.5 py-0.5 rounded border border-orange-800" }, /* @__PURE__ */ import_react16.default.createElement(import_lucide_react9.Ban, { className: "w-2.5 h-2.5" }), "Skip")), /* @__PURE__ */ import_react16.default.createElement("div", { className: `text-[10px] mt-0.5 ${isDisabled ? "text-brand-text-primary" : "text-brand-text-primary"}` }, fieldCount > 0 ? `${fieldCount} field${fieldCount !== 1 ? "s" : ""} \xB7 saves to ctx.${data?.outputVariable || "collectedData"}` : "No fields defined yet")), /* @__PURE__ */ import_react16.default.createElement("div", { className: "flex flex-col items-center justify-center px-2 border-l border-brand-border" }, /* @__PURE__ */ import_react16.default.createElement(
    "div",
    {
