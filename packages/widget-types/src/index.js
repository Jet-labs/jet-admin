...
export const WIDGET_INITIAL_CONFIG = {
  ...
  bar: {
    options: {
      ...
      scales: {
        x: {
          // Category axis
          beginAtZero: true, // Example: Start the x-axis at zero
        },
        y: {
          // Linear axis
          beginAtZero: true, // Example: Start the y-axis at zero
        },
      },
    },
  },
  line: {
    options: {
      ...
      elements: {
        line: {
          tension: 0.4, // Example: Add some curve to the line
        },
        point: {
          radius: 3, // Example: Set the radius of data points
        },
      },
    },
  },
  pie: {
    options: {
      ...
      plugins: {
        ...
        legend: {
          display: true,
          position: "right", // Example: Place legend on the right
        },
        tooltip: {
          enabled: true,
        },
    ...
    options: {
      ...
      scales: {
        r: {
          ...
          beginAtZero: true,
          angleLines: {
            display: true, // Example: Display lines radiating from the center
          },
          pointLabels: {
            display: true, // Example: Display labels for each spoke
          },
          suggestedMin: 0, // Example: Set a suggested minimum value
          suggestedMax: 100, // Example: Set a suggested maximum value
        },
      },
      elements: {
        line: {
          tension: 0, // Example: Straight lines between points
        },
        point: {
          radius: 3,
        },
    ...
    options: {
      ...
      scales: {
        r: {
          ...
          beginAtZero: true,
          pointLabels: {
            display: true, // Example: Display labels around the chart
          },
        },
      },
      elements: {
        arc: {
          borderColor: "#fff", // Example: White border between segments
          borderWidth: 2,
        },
      },
    },
...
export const WIDGET_DATASET_ADVANCED_OPTIONS = [
  ...
  },
  {
    ...
    relevantWidgets: ["line", "scatter", "bubble", "radar"], // Point style is relevant to several point-based charts
  },
  {
  ...
  },
  {
    name: "Fill Area",
    key: "line.fill",
    type: "boolean", // Assuming boolean fill for simplicity, Chart.js can use strings too
    description: "Fill the area below the line",
    relevantWidgets: ["line", "radar", "polarArea"], // Fill is also relevant for Radar and Polar Area
  },
  {
    name: "Point Rotation",
  ...
  },
  {
    ...
    relevantWidgets: ["line", "radar"], // Span gaps might be relevant for Radar too
  },
  {
    ...
    relevantWidgets: ["line", "radar"], // Line styles relevant for Radar
  },
  {
  ...
  // Bar Chart Specific Configurations
  {
    name: "Base Value",
    key: "bar.base",
    type: "number", // Assuming number base for simplicity
  ...
  },
  {
    ...
    type: "boolean", // Assuming boolean skip for simplicity, Chart.js can use strings
    description:
      "Which borders to skip drawing ('start', 'end', 'left', 'right', 'top', 'bottom', or boolean)",
    relevantWidgets: ["bar"],
  },
  {
  ...
  // Pie Chart Specific Configurations (Also relevant for Doughnut, which is a variant)
  {
    ...
    relevantWidgets: ["pie", "doughnut"], // Assuming 'doughnut' is a value
  },
  {
    name: "Circumference",
  ...
  },
  {
    name: "Cutout",
    key: "pie.cutout",
    type: "number", // Assuming number or percentage string
    description:
      "The portion of the inner radius to cut out (e.g., 50 for 50%)",
    relevantWidgets: ["pie", "doughnut"],
  },
  {
    name: "Offset",
  ...
  },
  {
    ...
    relevantWidgets: ["pie", "doughnut", "polarArea"], // Weight is also used in Polar Area
  },
  {
    name: "Border Align",
    key: "pie.borderAlign",
  ...
  },
  {
    ...
    relevantWidgets: ["pie", "doughnut", "polarArea"], // Border width relevant for Polar Area
  },
  {
  ...
  {
    name: "Bubble Style",
    key: "bubble.pointStyle", // Note: uses pointStyle property name
    type: "select",
