          ...
          <Button
            ...
            className={`h-auto py-1.5 flex-1 min-w-[60px] px-2 text-xs font-medium ${
              isSelected 
                ...
                : 'text-brand-text-primary border-transparent hover:bg-brand-border-dark'
            }`}
            title={`${opt.label}: ${opt.desc}`}
          >
            <span className={`mr-1.5 ${isSelected ? 'text-indigo-500' : 'text-brand-text-primary'}`}>{opt.icon}</span>
