...
export const RadioGroupConfigEditor = ({ widgetEditorForm, stateTree }) => {
  ...
  return (
    <div className="space-y-2">
      <div className="space-y-1">
        ...
        <Input type="text" className="text-sm h-8" value={config.label || ""} onChange={(e) => widgetEditorForm.setFieldValue("widgetConfig.label", e.target.value)} placeholder="e.g. Priority" />
      </div>
      <div className="space-y-1">
      ...
      <div className="space-y-1">
        ...
        <Select value={config.orientation || "vertical"} onValueChange={(v) => widgetEditorForm.setFieldValue("widgetConfig.orientation", v)}>
      ...
      <div className="space-y-1">
        ...
        <TemplateAutocompleteInput value={config.defaultValue || ""} onChange={(v) => widgetEditorForm.setFieldValue("widgetConfig.defaultValue", v)} placeholder="e.g. high" liveStateTree={liveStateTree} />
      </div>
      <div className="space-y-1">
...
RadioGroupConfigEditor.propTypes = { widgetEditorForm: PropTypes.object.isRequired, stateTree: PropTypes.object };
