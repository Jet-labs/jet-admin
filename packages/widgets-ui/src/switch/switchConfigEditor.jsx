...
export const SwitchConfigEditor = ({ widgetEditorForm, stateTree }) => {
  ...
  return (
    <div className="space-y-2">
      <div className="space-y-1">
        ...
        <Input type="text" className="text-sm h-8" value={config.label || ""} onChange={(e) => widgetEditorForm.setFieldValue("widgetConfig.label", e.target.value)} placeholder="e.g. Active only" />
      </div>
      <div className="space-y-1">
      ...
      <div className="flex items-center gap-2 pt-1">
        <Checkbox id="sw-default" checked={!!config.defaultChecked} onCheckedChange={(c) => widgetEditorForm.setFieldValue("widgetConfig.defaultChecked", !!c)} />
        <Label htmlFor="sw-default" className="text-xs text-muted-foreground cursor-pointer">On by default</Label>
      </div>
      <div className="space-y-1">
...
SwitchConfigEditor.propTypes = { widgetEditorForm: PropTypes.object.isRequired, stateTree: PropTypes.object };
export default SwitchConfigEditor;
