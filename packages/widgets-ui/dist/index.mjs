...
var VariableCategory = ({
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: "mb-1" }, /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement("span", { className: "text-[10px] px-1.5 py-0.5 rounded bg-background border border-border text-muted-foreground" }, variables.length)
...
var VariableExplorer = ({
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: `flex flex-col rounded-lg border border-border bg-background ${className}` }, /* @__PURE__ */ React2.createElement("div", { className: "flex items-center justify-between px-3 py-2 rounded-t-lg border-b border-border bg-muted/50" }, /* @__PURE__ */ React2.createElement("h3", { className: "text-xs font-medium text-muted-foreground" }, title)), showSearch && hasVariables && /* @__PURE__ */ React2.createElement("div", { className: "px-2 py-2 border-b border-border" }, /* @__PURE__ */ React2.createElement(
    Input,
    {
      type: "text",
