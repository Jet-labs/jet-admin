...
- **Authentication Middleware** (`auth.middleware.js`): Validates Firebase authentication
...
2. Firebase returns firebase token to client
3. Client includes firebase in Authorization header for subsequent requests
